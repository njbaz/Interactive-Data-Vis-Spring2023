...
// add axes
    const xAxis = d3.axisBottom(xScale).ticks(3).tickFormat(d3.format("d"))
...
//UPDATE THE STATE LINE ON THE LINE CHART
...
//store negative values in a constant "negvals"
const negVals = barfilteredData.map(d => d.scoreDiff < 0 ? d : {scoreDiff: 0})
// Draw rects for negative values by passing negVals as the data
